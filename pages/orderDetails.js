...
const viewOrderDetails = (obj) => {
  ...
  domString += `<button id="add-order-item-btn--${obj.firebaseKey}" type="button" class="btn btn-primary">Add Item</button>`;

  domString += obj.open ? `<button id="go-to-payment-btn--${obj.firebaseKey}" type="button" class="btn btn-success">Go to Payment</button>` : '';
